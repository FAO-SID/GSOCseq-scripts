...
WD_OUT<-("D:/TRAINING_MATERIALS_GSOCseq_MAPS_12-11-2020/OUTPUTS/3_FOWARD")
...
WARM_UP<-readOGR("OUTPUTS/2_WARM_UP/WARM_UP_County_AOI_parallell_test.shp")
...
writeOGR(FOWARD, ".", "FOWARD_County_AOI_parallel_test", driver="ESRI Shapefile",overwrite=TRUE) 
