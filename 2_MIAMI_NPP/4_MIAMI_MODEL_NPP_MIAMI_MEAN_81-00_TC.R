...
WD_NPP<-("D:/TRAINING_MATERIALS_GSOCseq_MAPS_12-11-2020/INPUTS/NPP_Nigeria")
...
WD_TC_LAYERS<-("D:/TRAINING_MATERIALS_GSOCseq_MAPS_12-11-2020/INPUTS/TERRA_CLIME_Nigeria")

setwd(WD_TC_LAYERS)

# Open Anual Precipitation (mm) and Mean Anual Temperature (grades C) stacks

Temp<-stack("AverageTemperature_1981-2001.tif")
Prec<-stack("Precipitation_1981-2001.tif")

setwd(WD_AOI)
AOI<-readOGR("COUNTRY_BORDERS.shp")
