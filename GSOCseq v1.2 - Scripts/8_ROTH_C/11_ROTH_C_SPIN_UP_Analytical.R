...
#                                          # 
#   GSOCseq: Script 11                     #
#   Spin up phase -Analytical Solution     #
#                                          #
...
C_INPUT_EQ<-vect("INPUTS/TARGET_POINTS/THA_NP_Target_points.shp")


# Stack_Set_1 is a stack that contains the spatial variables 
Stack_Set_1<- rast("INPUTS/STACK/THA_NP_Stack_Set_SPIN_UP.tif")
...
Vector_variables<-extract(Stack_Set_1,C_INPUT_EQ,df=TRUE)
...
# Convert C_Input_EQ to sp object for faster computation
...
C_INPUT_EQ <-vect(C_INPUT_EQ)
writeVector(C_INPUT_EQ, paste0("OUTPUTS/1_SPIN_UP/", ISO, "SPIN_UP.shp"),overwrite=TRUE) 
