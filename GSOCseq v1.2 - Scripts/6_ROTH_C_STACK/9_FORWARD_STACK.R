...
#                                          #                                                                           
#                                          # 
#   GSOCseq: Script 9 Forward stack        #
#                                          #
#                                          #  
#   Isabel Luotto                          #
...
path_PREC<-("INPUTS/TERRA_CLIMATE/Prec_Stack_01-20_TC.tif")
path_TEMP<-("INPUTS/TERRA_CLIMATE/Temp_Stack_01-20_TC.tif")
path_PET<-("INPUTS/TERRA_CLIMATE/PET_Stack_01-20_TC.tif")
...
writeRaster(Stack_Set_AOI,filename=(paste0("INPUTS/STACK/",ISO,"_Stack_Set_Forward.tif")),overwrite=TRUE)
