...
tmp<-stack("AverageTemperature_2001-2018.tif")

pre_01_18<-stack("Precipitation_2001-2018.tif")

pet_01_18<-stack("PET_2001-2018.tif")
...
writeRaster(Temp_Stack,filename='Temp_Stack_01-18_TC.tif',"GTiff",overwrite=TRUE)
...
writeRaster(Prec_Stack,filename='Prec_Stack_01-18_TC.tif',"GTiff",overwrite=TRUE)
...
writeRaster(PET_Stack,filename='PET_Stack_01-18_TC.tif',"GTiff",overwrite=TRUE)
