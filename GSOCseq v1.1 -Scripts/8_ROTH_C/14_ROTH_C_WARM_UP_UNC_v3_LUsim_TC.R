...
PREC<-stack("INPUTS/TERRA_CLIME_Nigeria/Precipitation_2001-2020.tif")
TEMP<-stack("INPUTS/TERRA_CLIME_Nigeria/AverageTemperature_2001-2020.tif")*0.1
PET<-stack("INPUTS/TERRA_CLIME_Nigeria/PET_2001-2020.tif")*0.1



#Open Mean NPP MIAMI 1981 - 2000

NPP<-raster("INPUTS/NPP_Nigeria/NPP_MIAMI_MEAN_81-00_AOI.tif")

NPP_MEAN_MIN<-raster("INPUTS/NPP_Nigeria/NPP_MIAMI_MEAN_81-00_AOI_MIN.tif")

NPP_MEAN_MAX<-raster("INPUTS/NPP_Nigeria/NPP_MIAMI_MEAN_81-00_AOI_MAX.tif")
