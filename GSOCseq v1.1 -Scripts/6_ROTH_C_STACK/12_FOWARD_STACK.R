...
WD_CLIM<-("D:/TRAINING_MATERIALS_GSOCseq_MAPS_12-11-2020/INPUTS/TERRA_CLIME")

WD_LU<-("D:/TRAINING_MATERIALS_GSOCseq_MAPS_12-11-2020/INPUTS/LAND_USE")

WD_COV<-("D:/TRAINING_MATERIALS_GSOCseq_MAPS_12-11-2020/INPUTS/COV")
...
setwd(WD_CLIM)
PREC<-stack("Prec_Stack_01-19_TC.tif")
...
TEMP<-stack("Temp_Stack_01-19_TC.tif")
...
PET<-stack("PET_Stack_01-19_TC.tif")
