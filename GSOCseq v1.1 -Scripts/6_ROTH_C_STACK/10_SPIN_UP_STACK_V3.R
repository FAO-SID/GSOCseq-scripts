...
WD_CLAY<-("D:/TRAINING_MATERIALS_GSOCseq_MAPS_12-11-2020/INPUTS/CLAY")

WD_CLIM<-("D:/TRAINING_MATERIALS_GSOCseq_MAPS_12-11-2020/INPUTS/TERRA_CLIME_Paraguay")

WD_LU<-("D:/TRAINING_MATERIALS_GSOCseq_MAPS_12-11-2020/INPUTS/LAND_USE")

WD_COV<-("D:/TRAINING_MATERIALS_GSOCseq_MAPS_12-11-2020/INPUTS/COV_Paraguay")

WD_STACK<-("D:/TRAINING_MATERIALS_GSOCseq_MAPS_12-11-2020/INPUTS/STACK")

# Open the shapefile of the region/country
setwd(WD_AOI)
AOI<-readOGR("Paraguay.shp")

#Open SOC MAP FAO
setwd(WD_SOC)
SOC_MAP_AOI<-raster("SOC_MAP_AOI_Paraguay.tif")

# Open Clay layer

setwd(WD_CLAY)

Clay_WA_AOI<-raster("Clay_WA_AOI_Paraguay.tif")
...
PREC<-stack("Prec_Stack_81-00_TC.tif")
...
TEMP<-stack("Temp_Stack_81-00_TC.tif")
...
PET<-stack("PET_Stack_81-00_TC.tif")
...
LU_AOI<-stack("ESA_Land_Cover_12clases_FAO_Stack_AOI_Paraguay.tif")
LU_AOI<-LU_AOI[[1]] # first year of the stack
...
setwd(WD_STACK)
writeRaster(Stack_Set_AOI,filename=("Stack_Set_SPIN_UP_AOI_Paraguay.tif"),format="GTiff",overwrite=TRUE)
